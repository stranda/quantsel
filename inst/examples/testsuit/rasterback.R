...
k=rep(1000,rland$intparam$habitat) #need some sort of carrying capacity to initalize.  replaced in first gen
...
for (i in rasterlayers)
{
    ...
    l$demography$epochs[[1]]$Carry = calc.k.vec(k, hsl,i)
